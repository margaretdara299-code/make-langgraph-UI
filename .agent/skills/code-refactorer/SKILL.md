...
description: Refactors chaotic, overgrown React components into clean, modular, and maintainable code. Use when components are too long, logic is mixed with UI, or when the user asks to "clean up", "refactor", or "organize" a file.
---
