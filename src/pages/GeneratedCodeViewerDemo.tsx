    ...
    return (
        <div style={{ padding: '40px', minHeight: '100vh', background: '#f5f5f5' }}>
            <div style={{ maxWidth: '800px', margin: '0 auto' }}>
                ...
                <p>
                    View auto-generated project files from the Tensaw Skill Studio in a VS Code-like
                    interface with file explorer on the left and code viewer on the right.
                </p>
                ...
                <Space direction="vertical" style={{ width: '100%', marginTop: '30px' }}>
                    ...
                    <div style={{ marginTop: '20px', padding: '20px', background: '#f9f9f9', borderRadius: '8px' }}>
                        <h3>Usage Example:</h3>
                        <pre style={{ overflow: 'auto', background: '#1e1e1e', color: '#d4d4d4', padding: '16px' }}>
{`import { GeneratedCodeViewer } from '@/components';
import { useState } from 'react';
                        ...
                        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
                            ...
                            <tbody>
                                ...
                                <tr style={{ borderBottom: '1px solid #eee' }}>
                                    ...
                                    <td style={{ padding: '8px' }}>—</td>
                                    <td style={{ padding: '8px' }}>Callback when closing modal</td>
                                </tr>
                                <tr style={{ borderBottom: '1px solid #eee' }}>
